import { getSmallUserInfoByTokenReducer } from "../../../../store/reducers/getSmallUserInfoByTokenReducer";
import { GetSmallUserInfoActionTypes, GetSmallUserInfoAction } from "../../../../types/getSmallUserInfo";
